...
struct Storyboards {
    ...
    struct Main {
        ...
        static func instantiateInitialViewController() -> MainNavigationController {
            return self.storyboard.instantiateInitialViewController() as! MainNavigationController
        }
...
extension UIStoryboardSegue {
    func selection() -> MainNavigationController.Segue? {
        if let identifier = self.identifier {
            return MainNavigationController.Segue(rawValue: identifier)
        }
        return nil
    }
}
...
extension MainNavigationController { 
    ...
    enum Segue: String, CustomStringConvertible, SegueProtocol {
        case PermissionViewControllerSegue = "PermissionViewControllerSegue"

        var kind: SegueKind? {
            switch (self) {
            case PermissionViewControllerSegue:
        ...
        var destination: UIViewController.Type? {
            switch (self) {
            case PermissionViewControllerSegue:
                return PermissionViewController.self
            }
        }
